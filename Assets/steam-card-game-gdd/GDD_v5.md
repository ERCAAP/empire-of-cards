...
Oyuncu kucuk bir isletme kurar. Kartlarla kararlar verir: kimi ise alacak, nereden malzeme alacak, nasil pazarlama yapacak. Her karar bir sonuc dogurur. Sonuclar birbirine zincirlenir. Basari da tehlikeli, basarisizlik da ogretici.

> "Garajda basladim, dogru kararlarla semtin en buyuk isletmesini kurdum. Sonra sattim ve daha buyugune basladim."

## 1.2 Oyunun Cumlesi

Isletme kur, kart oyna, karar ver. Ucuz isci mi pahali sef mi? Kaliteli et mi karaborsa mi? Google reklam mi sahte yorum mu? Her kart bir karar, her karar bir sonuc, her sonuc yeni bir kriz veya firsat.

## 1.3 Tasarim Ilkeleri

1. Her kart bir KARAR, buyu degil. "Senior Sef mi, Stajyer mi?" gercek bir is karari.
2. Sonuclar ZINCIRLI: ucuz et > kalite dustü > kotu yorum > musteri azaldi > para bitti > daha ucuz isci > hijyen dustü > denetim geldi.
3. Oyuncu kart oynamiyor hisseder, ISLETME YONETIYOR hisseder.
4. 3 katmanli: KARTLAR (karar) + BOARD (isletme durumu) + SIMULASYON (sonuc).
5. Risk/odul dengesi: kisa yollar kisa vadede kazandirir, uzun vadede yok eder.
6. Basari bile tehlikeli: cok musteri gelirse yetisemezsin, kotu yorum yersin.
7. Sektor secimi kozmetik degil: kart havuzunu, krizleri, buyume egrisini tamamen degistirir.

## 1.4 Oyuncunun Her Tur Yaptigi Sey (1 dakika)

1. GOZLEMLE (10 sn): Board'a bak. "Mutfakta 1 asci, salon dolu, yarin ogle rusu, hijyen dusuk."
2. KARAR VER (30 sn): 5 karttan 3'unu sec, fiziksel olarak yerine koy.
3. IZLE (15 sn): Tur cozulur, animasyonla sonuclar gosterilir.
4. KRIZ/OLAY (5 sn): Otomatik olay tetiklenir, tepki ver veya izle.

## 1.5 Oyunun Ne Oldugu

```
KART OYUNU DEGIL:
  "Bu karti oyna, +3 musteri, +2 gelir" → SOYUT, SIKICI

SIMULASYON DEGIL:
  "37 parametreyi ayarla, Excel tablosu yonet" → KARMASIK, BUNALTICI

IKISININ HIBRITI:
  "Elinde 5 karar var. 3 tanesini sec. Sonuclarini izle."
  → ANLASILIR, GERCEKCI, BAGIMLILIK YAPICI
```
...
```
1. START GAME
2. ISLETME ADI gir (dukkanin adi)
3. SEKTOR SEC (ilk basta sadece Restaurant acik)
4. Board kurulur, rakip ayni sektorde acar
5. OYUN BASLAR (Tutorial ilk run'da otomatik)
```

## 2.2 Sektor Secimi ve Unlock Sistemi

Baslangicta 1 sektor acik. Diger sektorler basarili run'larla acilir:

| Siralama | Sektor | Unlock Kosulu | Kimlik |
|---|---|---|---|
| BASLANGIC | Restaurant / Kafe | Her zaman acik | Herkes anlar, en genis kitle |
| 2. run | Tech App | Ilk basarili exit | Dijital dunya, farkli mekanik |
| 3. run | Moda / Giyim | $10M toplam exit | Sezon mekamigi, trend |
| 4. run | Market / Bakkal | 2 farkli sektor tamamla | Dusuk marj, sadakat |
| 5. run | Fintech | $50M toplam exit | En zor, en stratejik |

Her sektor DERIN: 50+ ozel kart, benzersiz krizler, farkli ekonomi.
Sektorler arasinda ORTAK OMURGA: ayni slot sistemi, ayni stat modeli, ayni tur akisi.

## 2.3 MVP Kapsami

MVP = Sadece RESTAURANT sektoru, eksiksiz ve derin.
...
Board bir kart oyunu masasi DEGIL. Board DUKKANIN FIZIKSEL HALI.
Oyuncu yukari bakinca dukkaninin ici gorunur: mutfak, salon, depo.
Kartlar bu alanlara FIZIKSEL olarak oturur.
...
+----------------------------------------------------------+
|                                                          |
|  SOKAK / MUSTERI AKISI (en ust)                          |
|  Musteriler yurur: fiyat avcisi, gurme, sadik, influencer|
|  Market Share Bar: [████████░░░░░░░░░░] %34              |
|  Rating: ⭐⭐⭐⭐☆ (4.1) | Musteri: 34/100               |
|                                                          |
+----------------------------------------------------------+
|                                                          |
|  RAKIP DUKKANI (kisitli gorunur)                         |
|  [?][?][Reklam][Sef][?]  Rating: 4.3 | Musteri: 42      |
|  "Rakip fiyat kirdi!" veya "Rakip kalite arttirdi"       |
|                                                          |
+----------------------------------------------------------+
|                                                          |
|  SENIN DUKKANIN (tam gorunur, 3D kus bakisi)             |
|                                                          |
|  ┌─MUTFAK────────┐  ┌─SALON─────────┐  ┌─DEPO──────┐   |
|  │ [Sef] [Cylak] │  │ [Grsn] [    ] │  │ [Ksap]    │   |
|  │ [    ]        │  │ [Tmzl] [    ] │  │ [Frnc]    │   |
...
|                                                          |
|  ┌─MARKETING──────────────────────────────────────┐     |
|  │ [Google Rklm] [Brosur] [  BOS  ]              │     |
|  └────────────────────────────────────────────────┘     |
|                                                          |
|  ┌─OLAYLAR────────────────────────────────────────┐     |
|  │ [🔴 Hijyen Denetimi 2 tur!] [🟢 Viral Moment] │     |
|  └────────────────────────────────────────────────┘     |
|                                                          |
|  Hijyen: ██████░░░░ 6/10                                |
|  Kapasite: 5 musteri/tur                                 |
|  Kalite: 7.2/10                                          |
|                                                          |
+----------------------------------------------------------+
|                                                          |
|  ELINDEKI KARTLAR (3D, fan seklinde)                     |
|  [Snr Sef $30] [Ucuz Grsn $5] [Hldz Et $2]             |
|  [Ggl Rklm $25] [Acil Hire $25]                         |
|                                                          |
|  💰 $420  ⚡ 3 Aksiyon  📅 Tur 8/25  ☀️ Yaz            |
+----------------------------------------------------------+
```

## 3.3 Kart Yerlestirme

Oyuncu karti surukleyip fiziksel alana birakir:

- "Senior Sef" → MUTFAK'a birak → Kalite 5.2→7.2
- "Ucuz Garson" → SALON'a birak → Kapasite 3→3.5 ama siparis karisir
- "Karaborsa Et" → DEPO'ya birak → Maliyet -$15 ama Legal Risk +8
- "Google Reklam" → MARKETING'e birak → Musteri akisi artar
- "Temizlikci" → SALON'a birak → Hijyen artar

Kart oturunca ANINDA stat degisimi gosterilir (yesil/kirmizi sayi animasyonu).

## 3.4 Rakip Zone

Rakibin dukkani kisitli gorunur. Tam detay yok ama:
- Hangi slot'lari doldurdugunu gorebilirsin (icon)
- Rating ve musteri sayisini gorebilirsin
- Her tur bir "rakip hamlesi" bildirimi gelir
- Rakibin ne yone gittigini OKUYABILMELISIN
...
Tum sektorler ayni 5 slot ailesini kullanir. Isimler sektore gore degisir.

### Restaurant icin:

| Slot | Restaurant Karsiligi | Amac |
|---|---|---|
| Operation | MUTFAK | Yemek uretimi, kapasite, kalite |
| Staff | SALON + MUTFAK Personeli | Servis, temizlik, ascilik |
| Marketing | PAZARLAMA | Musteri cekme, gorunurluk |
| Supplier | DEPO / TEDARIK | Malzeme kalitesi ve maliyeti |
| Temp Effect | OLAYLAR | Krizler, gecici boost/penalty |

### Tech App icin (unlock sonrasi):

| Slot | Tech Karsiligi | Amac |
|---|---|---|
| Operation | PRODUCT | MVP, backend, feature |
| Staff | TEAM | Developer, designer, QA |
| Marketing | GROWTH | ASO, ads, influencer |
| Supplier | INFRA | Cloud, SDK, API |
| Temp Effect | MARKET EVENTS | Store feature, crash, clone |

## 4.2 Baslangic Slot Sayilari (4 Cag)

| Slot | Cag 1 (Tur 1-6) | Cag 2 (Tur 7-13) | Cag 3 (Tur 14-19) | Cag 4 (Tur 20-25) |
|---|---|---|---|---|
| Mutfak (Operation) | 2 | 3 | 4 | 5 |
| Personel (Staff) | 3 | 4 | 6 | 7 |
| Marketing | 1 | 2 | 3 | 3 |
| Depo/Tedarik (Supplier) | 1 | 2 | 2 | 3 |
| Olaylar (Temp) | 2 | 3 | 3 | 3 |
| TOPLAM | 9 | 14 | 18 | 21 |
| Aksiyon/tur | 2 | 3 | 4 | 5 |

## 4.3 Alt-Slot Isimleri (Restaurant)

- Mutfak: Ana Ocak, Izgara, Hazirlik Tezgahi, Firinda, Tatli Istasyonu
- Personel: Asci, Garson, Kasiyer, Temizlikci, Kurye, Sube Muduru, Komi
- Marketing: Brosur, Google, Instagram, Yemek App, Yerel Etkinlik
- Tedarik: Kasap, Manav, Firinci, Icecek, Toptan Gida
- Olaylar: (otomatik dolar - krizler, viral anlar, mevsim etkileri)

## 4.4 Slot Felsefesi

Oyuncu her seyi ayni anda yapamaz. Cag 1'de 9 slot = cok az yer.
Bu sinirlilik STRATEJIYI dogurur:

- Senior sef mi alayim yoksa 2 stajyer mi?
- Kasaptan kaliteli et mi yoksa ucuz donmus et mi?
