...
namespace EmpireOfCards.Bootstrap
{
    public class ManagerBundle
    {
        ...
        public GameSceneBuilder sceneBuilder;
    ...
    public static class ManagerFactory
    {
        public static ManagerBundle CreateAll()
        {
            ...
            var bundle = new ManagerBundle
            {
                ...
                sceneBuilder     = Create<GameSceneBuilder>(worldRoot),
                cameraController = Create<CameraController>(worldRoot),
                doTweenAnimations = Create<DOTweenAnimations>(worldRoot)
            };
