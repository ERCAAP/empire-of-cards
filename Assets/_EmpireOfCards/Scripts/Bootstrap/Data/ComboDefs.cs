    ...
    public static class ComboDefs
    {
        public static ComboData[] Create(CardData[] allCards)
        {
            ...
            // Buffed from +30 to +40 income (was ~14%, now ~19% of turn 10 income).
            {
                ...
                c.requiredCardIds = new[] { "B03_BurgerChain", "C04_Chef" };
                c.requiredTags = new[] { CardTag.Food };
                c.requiresSpecificPlacement = true;
                c.employeeCardId = "C04_Chef";
                c.businessCardId = "B03_BurgerChain";
                c.bonusIncome = 40;
            ...
            // COMBO 03 - Viral Storm (Easy)
            {
                ...
                c.requiredCardIds = new[] { "B04_TechStartup", "C05_MarketingGuru" };
                c.requiredTags = new[] { CardTag.Tech, CardTag.Marketing };
                c.requiresSpecificPlacement = true;
                c.employeeCardId = "C05_MarketingGuru";
            ...
            {
                var c = ScriptableObject.CreateInstance<ComboData>();
                c.name = "COMBO_04_NightlifeFrenzy";
                c.comboId = "COMBO_04_NightlifeFrenzy";
                c.comboName = "Nightlife Frenzy";
                c.displayText = "NIGHTLIFE FRENZY!";
                c.tier = ComboTier.Medium;
                c.description = "Nightclub + Influencer + Viral Trend event = customers x3.";
                c.requiredCardIds = new[] { "B05_Nightclub", "C06_Influencer" };
                c.requiredTags = new[] { CardTag.Trendy, CardTag.Entertainment };
                c.requiresSpecificPlacement = true;
                c.employeeCardId = "C06_Influencer";
                c.businessCardId = "B05_Nightclub";
            ...
            // COMBO 05 - Underground Empire (Medium)
            {
                ...
                c.requiredCardIds = new[] { "C07_Hacker", "C09_Fraudster" };
            ...
            // COMBO 06 - Safe Crime (Medium)
            {
                ...
                c.requiredCardIds = new[] { "C08_Accountant", "C09_Fraudster" };
            ...
            // COMBO 07 - AI Revolution (Hard)
            {
                ...
                c.requiredCardIds = new[] { "B04_TechStartup", "U02_Automation", "U06_AIAssistant" };
            ...
            // COMBO 08 - Ad Blitz (Medium)
            {
                ...
                c.requiredCardIds = new[] { "B06_OrganicFarm", "B03_BurgerChain", "C04_Chef" };
            ...
            // COMBO 09 - Crisis Hunter (Hard)
            {
                ...
                c.requiredTags = new[] { CardTag.Finance };
                c.requiresActiveEvent = true;
                c.requiredEventId = "E02_EconomicCrisis";
            ...
            // build multiple businesses, but the combo only fires with Delivery Network attached.
            {
                ...
                c.requiredCardIds = new[] { "B09_FranchiseHub", "U03_DeliveryNetwork" };
            ...
            // Easy to discover because Bouncer's nightlife tag hints at entertainment pairing.
            {
                ...
                c.requiredCardIds = new[] { "B10_LuxuryBoutique", "C12_Bouncer" };
                c.requiredTags = new[] { CardTag.Luxury };
                c.requiresSpecificPlacement = true;
                c.employeeCardId = "C12_Bouncer";
                c.businessCardId = "B10_LuxuryBoutique";
                c.bonusIncome = 80;
                c.bonusCustomers = 4;
            ...
            // Hard to assemble but creates a money printing engine.
            {
                ...
                c.requiredCardIds = new[] { "B11_ConsultingFirm", "C09_Fraudster", "C08_Accountant" };
            ...
            // creates exponential late-game income. Reward for patient, long-term play.
            {
                ...
                c.requiredCardIds = new[] { "B09_FranchiseHub", "C11_Consultant", "U07_BreakRoom" };
