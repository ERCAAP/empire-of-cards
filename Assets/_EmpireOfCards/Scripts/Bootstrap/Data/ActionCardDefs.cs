...
namespace EmpireOfCards.Bootstrap.Data
{
    ...
    public static class ActionCardDefs
    {
        public static CardData[] Create()
        {
            ...
            // A01 - Flyer
            cards[0] = CardHelper.CreateAction("A01_Flyer", "Flyer", Rarity.Common,
            ...
            cards[1] = CardHelper.CreateAction("A02_SmallInvestment", "Small Investment", Rarity.Common,
                "Quick cash. Starter card.", 0,
                ActionEffectType.AddMoneyInstant, 150, 0f, 0,
                new[] { CardTag.Finance, CardTag.Basic });

            // A03 - Viral Marketing
            cards[2] = CardHelper.CreateAction("A03_ViralMarketing", "Viral Marketing", Rarity.Uncommon,
            ...
            cards[3] = CardHelper.CreateAction("A04_HostileTakeover", "Hostile Takeover", Rarity.Rare,
                "Expensive but directly weakens rival.", 400,
                ActionEffectType.CloseRivalWeakestBusiness, 0, 0f, 0,
                new[] { CardTag.Aggressive });

            // A05 - Fake Reviews
            cards[4] = CardHelper.CreateAction("A05_FakeReviews", "Fake Reviews", Rarity.Uncommon,
                "Cheap customers. But risky.", 80,
                ActionEffectType.AddCustomersWithFBI, 8, 0f, 12,
                new[] { CardTag.Marketing, CardTag.Illegal });

            // A06 - Price Slashing
            cards[5] = CardHelper.CreateAction("A06_PriceSlashing", "Price Slashing", Rarity.Uncommon,
            ...
            // A07 - Sabotage
            cards[6] = CardHelper.CreateAction("A07_Sabotage", "Sabotage", Rarity.Rare,
                "Powerful but very risky.", 250,
                ActionEffectType.DisableRivalOneTurn, 0, 0f, 15,
                new[] { CardTag.Aggressive, CardTag.Illegal });

            // A08 - Investor Pitch
            cards[7] = CardHelper.CreateAction("A08_InvestorPitch", "Investor Pitch", Rarity.Uncommon,
            ...
            // A09 - Emergency Hire
            cards[8] = CardHelper.CreateAction("A09_EmergencyHire", "Emergency Hire", Rarity.Uncommon,
                "Quick employee. But random.", 100,
                ActionEffectType.DrawAndPlayEmployee, 0, 0f, 0,
                new[] { CardTag.Hiring });

            // A10 - Liquidation Sale
            cards[9] = CardHelper.CreateAction("A10_LiquidationSale", "Liquidation Sale", Rarity.Common,
            ...
            cards[10] = CardHelper.CreateAction("A11_HostileMerger", "Hostile Merger", Rarity.Rare,
            ...
            cards[11] = CardHelper.CreateAction("A12_AllIn", "All In", Rarity.Rare,
            ...
            cards[12] = CardHelper.CreateAction("A13_InsuranceClaim", "Insurance Claim", Rarity.Uncommon,
