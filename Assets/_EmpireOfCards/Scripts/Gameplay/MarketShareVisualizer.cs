...
{
    /// <summary>
    /// Active system: adapts customer share to visual market-share blocks.
    /// This is the current market-zone presentation layer for the v4 venture-first
    /// runtime. Win/lose is resolved elsewhere; this class is visual-only.
    /// </summary>
    public class MarketShareVisualizer : MonoBehaviour
    {
        // --- Configuration ---
